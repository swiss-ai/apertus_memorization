...
#SBATCH --job-name=apertus-mem
#SBATCH --output=/iopsstor/scratch/cscs/xyixuan/PDM/src/apertus/experiments/logs/apertus-full-%A_%a.out
#SBATCH --error=/iopsstor/scratch/cscs/xyixuan/PDM/src/apertus/experiments/logs/apertus-full-%A_%a.err
...
echo "=========================================="
echo "Apertus Positional Offset Experiment - Array Job"
echo "=========================================="
...
python $SCRIPT_PATH \
    ...
    --repetitions 0a 0b 0c 0d 1 2 3 4 8 16 24 32 48 64 96 128 \
    --prefix-length 500 \
    --suffix-length 500 \
    --offset 0 1 2 4 16 32 64 128 256 512 1024 2048 \
